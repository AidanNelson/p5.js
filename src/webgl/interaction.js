...
p5.prototype.orbitControl = function(sensitivityX, sensitivityY) {
  ...
  if (this.mouseIsPressed) {
    ...
    // translate camera Matrix around current target
    p5.Matrix.prototype.translate.apply(camMatrix, [
      [
        -this._renderer.cameraTargetX,
        -this._renderer.cameraTargetY,
        -this._renderer.cameraTargetZ
      ]
    ]);

    console.log(
      'newCamera translation: ' +
        camMatrix.mat4[12] +
        ', ' +
        camMatrix.mat4[13] +
        ', ' +
